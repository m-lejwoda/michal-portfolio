...
const Aboutme = () => {
    ...
    return (
        <div data-aos="fade-right" className="aboutme__container">
            ...
            <div className="aboutme__container__description">My name is Michał Lejwoda. I graduated with a master's degree in computer science from Marie curie sklodowska University.
